        ...
        <ul className="nav">
          ...
          <li className={this.isPathActive('/workers') ? 'nav-item active' : 'nav-item'}>
            <Link className="nav-link" to="/workers">
              <i className="mdi mdi-television menu-icon"></i>
              <span className="menu-title"><Trans>Workers</Trans></span>
            </Link>
          </li>
          <li className={this.isPathActive('/vendors') ? 'nav-item active' : 'nav-item'}>
            <Link className="nav-link" to="/vendors">
              <i className="mdi mdi-television menu-icon"></i>
              <span className="menu-title"><Trans>Vendors</Trans></span>
            </Link>
          </li>
